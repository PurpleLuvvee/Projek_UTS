...
<?php
// select all data from table "orders"
    ...
    <div id="layoutSidenav">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="../type/type.php" id="col-hover">Type Produk</a>
                            </nav>
                        </div>
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                ...
                <br>
                <a class="btn btn-primary" href="form_type.php">Tambah +</a>
                <div class="jobs">
                                ...
                                foreach ($rs as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info" href="view_type.php?id=<?= $row['id'] ?>">View</a>
                                            <a class="btn btn-warning" href="form_type.php?id=<?= $row['id'] ?>">Edit</a>
                                            <a class="btn btn-danger" href="delete_type.php?id=<?= $row['id'] ?>"
