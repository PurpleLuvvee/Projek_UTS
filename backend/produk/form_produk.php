                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="input-group">
                                ...
                                <input id="nama_motor" name="nama_motor" type="text" class="form-control" value="<?php if (isset($row['nama_motor']))
                                echo $row['nama_motor']; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="input-group">
                                ...
                                <input id="cc" name="cc" value="<?php if (isset($row['cc']))
                                echo $row['cc']; ?>" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                        <label for="tipe_motor_id" class="col-4 col-form-label">Id Tipe Motor</label>
                        <div class="col-8">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                </div>
                                <input id="tipe_motor_id" name="tipe_motor_id" value="<?php if (isset($row['tipe_motor_id']))
                                echo $row['tipe_motor_id']; ?>" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="input-group">
                                ...
                                <input id="harga" name="harga" value="<?php if (isset($row['harga']))
                                echo $row['harga']; ?>" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="input-group">
                                ...
                                <input id="merk_id" name="merk_id" value="<?php if (isset($row['merk_id']))
                                echo $row['merk_id']; ?>" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="input-group">
                                ...
                                <input id="stok" name="stok" value="<?php if (isset($row['stok']))
                                echo $row['stok']; ?>" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <br>
