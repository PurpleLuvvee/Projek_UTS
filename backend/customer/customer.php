    ...
    <div id="layoutSidenav">
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../customer/customer.php" id="col-hover">Customer</a>
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                <h1>List Customer</h1>
                <br>
                <a class="btn btn-primary" href="form_customer.php">Tambah +</a>
                <div class="jobs">
                                ...
                                foreach ($rs as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-info" href="view_customer.php?id=<?= $row['id'] ?>">View</a>
                                            <a class="btn btn-warning"
                                                href="form_customer.php?id=<?= $row['id'] ?>">Edit</a>
