    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main id="main-content">
                <h1>List Order</h1>
                <br>
                <a class="btn btn-primary" href="form_orders.php">Tambah +</a>
                <div class="jobs">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" href="view_orders.php?id=<?= $row['id'] ?>">View</a>
                                        <a class="btn btn-warning" href="form_orders.php?id=<?= $row['id'] ?>">Edit</a>
                                        <a class="btn btn-danger" href="delete_orders.php?id=<?= $row['id'] ?>"
                                            onclick="if(!confirm('Anda Yakin Hapus Data <?= $row['id'] ?>?')) {return false}">Delete</a>
                                    </td>
                                </tr>
                                <?php
                                    // increment counter
